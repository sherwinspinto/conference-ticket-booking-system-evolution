...
public class TicketEntity2 {
  ...
  protected TicketEntity2() {}

  public TicketEntity2(
  ...
  public static TicketEntity2 fromDomain(ReserveTicket reserveTicket) {
    return new TicketEntity2(
        null,
  ...
  public static Ticket toDomain(TicketEntity2 ticketEntity) {
